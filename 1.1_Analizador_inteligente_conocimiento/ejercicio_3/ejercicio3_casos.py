...
with open(RUTA_IDEAS, "r", encoding="utf-8") as f:
    principios = json.load(f).get("ideas_principales", [])
...
Crea {CANTIDAD_CASOS} casos de estudio con dificultad '{DIFICULTAD}'.
...
{{
  "casos": [
    {{
      ...
      "opcion_recomendada": "A",
      "principio_relacionado": "Principio",
      "justificacion": "Fundamentación en el PDF"
    }}
  ]
}}
"""
...
with open(os.path.join(CARPETA_SALIDA, "ejercicio3_casos.json"), "w", encoding="utf-8") as f:
