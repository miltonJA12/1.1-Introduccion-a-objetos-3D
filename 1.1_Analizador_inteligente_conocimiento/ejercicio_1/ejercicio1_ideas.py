...
prompt = f"""
Analiza el PDF adjunto y extrae exactamente hasta {CANTIDAD_MAXIMA_IDEAS} ideas o principios principales.
...
{{
  "ideas_principales": [
    {{
      ...
      "parte_documento": "Capítulo o sección",
      "evidencia": "Cita breve del PDF"
    }}
  ]
}}
"""
...
with open(os.path.join(CARPETA_SALIDA, "ejercicio1_ideas.json"), "w", encoding="utf-8") as f:
